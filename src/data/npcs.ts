...
export const NPCS: Npc[] = [
  // ===== 射雕英雄传 =====
  {
    ...
    alignment: "正",
    roles: ["剧情"],
    description: "郭盛之后，定居牛家村，以双戟护家守义，性情豪直。",
    combat: {
      hp: 150, hpMax: 150, mp: 40, mpMax: 40,
      attack: 24, defense: 15, speed: 12, statuses: [],
      skills: [getSkillById("changquan")!],
      expReward: 90, goldReward: 30,
    },
    dialogue: "郭啸天按住双戟。郭啸天：\"先护住家眷，再和他们算账。\"",
  },
  {
    id: "yangtiexin",
    name: "杨铁心",
    ...
    alignment: "正",
    roles: ["剧情"],
    description: "杨再兴之后，精于杨家枪法，与郭啸天结为异姓兄弟。",
    combat: {
      hp: 145, hpMax: 145, mp: 45, mpMax: 45,
      attack: 25, defense: 14, speed: 14, statuses: [],
      skills: [getSkillById("changquan")!],
      expReward: 90, goldReward: 30,
    },
    dialogue: "杨铁心横枪守门。杨铁心：\"杨家枪在此，谁也别想从这道门过去。\"",
  },
  {
    id: "baoxiruo",
    name: "包惜弱",
    ...
    alignment: "正",
    roles: ["剧情"],
    description: "杨铁心之妻，心地柔软，即使身处祸乱也不肯见伤者死在眼前。",
    combat: {
      hp: 110, hpMax: 110, mp: 35, mpMax: 35,
      attack: 12, defense: 10, speed: 10, statuses: [],
      skills: [getSkillById("changquan")!],
      expReward: 60, goldReward: 15,
    },
    dialogue: "包惜弱守着药炉。包惜弱：\"来路可以慢慢问，伤势却等不得。\"",
  },
  {
    id: "niujia-coach",
    name: "陆教头",
    ...
    alignment: "中",
    roles: ["对手", "剧情"],
    description: "退下来的乡兵教头，以长拳和白蜡杆带村中青壮守夜，重架势胜过花招。",
    combat: {
      hp: 60, hpMax: 60, mp: 20, mpMax: 20,
      attack: 5, defense: 6, speed: 5, statuses: [],
      skills: [getSkillById("changquan")!],
      expReward: 28, goldReward: 0,
    },
    locationId: "niujia",
    dialogue: "陆教头把白蜡杆横在身前。陆教头：\"先守住三招，再谈练成了什么。\"",
  },
  {
    id: "guojing",
    name: "郭靖",
