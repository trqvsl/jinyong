...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    power: 40,
    mpCost: 20,
    description: "丐帮绝学，至刚至阳的掌法，掌风横扫全场，威力惊人。",
    innerScale: 1.0,
    targeting: "all-enemy",
  },
  {
    ...
    power: 42,
    mpCost: 18,
    description: "独孤求败所创，破尽天下武学。剑出如电，连点数人。",
    innerScale: 0.5,
    targeting: "random3",
  },
  {
    ...
    power: 44,
    mpCost: 22,
    description: "大理段氏绝学，以指力发出无形剑气，剑气连射分袭两人。",
    innerScale: 1.0,
    targeting: "spread2",
  },
 {
 ...
 },
 {
  ...
  // ---------- 金庸角色专属武功（首批练手） ----------
  {
    ...
    power: 38,
    mpCost: 20,
    description: "西毒欧阳锋绝学。蓄势如蛤蟆，发劲雷霆万钧，气劲横扫四方。",
    innerScale: 1.0,
    targeting: "all-enemy",
  },
  {
    ...
    power: 22,
    mpCost: 12,
    description: "白驼山庄毒功。拳路诡毒如灵蛇，伤敌并令其中毒，3回合持续掉血。",
    effect: {
      target: "enemy",
      kind: "poison",
      potency: 12,
