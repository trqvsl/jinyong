...
export const LOCATIONS: Location[] = [
  // ===== 江南 =====
  {
    ...
    events: ["shendiao-niujia", "shendiao-yangkang", "shendiao-niujia-snow", "shendiao-munianci"],
  ...
  },
  {
    ...
    events: ["shendiao-meet-rong", "shendiao-qigong", "shendiao-wangfu", "shendiao-beggar-feast", "shendiao-yuefei-wall", "shendiao-linan-nighttalk", "linan-teahouse", "linan-nightmarket"],
    enemyPool: ["xialiubang", "shanzei"],
  ...
  // ===== 塞北 =====
  {
    ...
    events: ["shendiao-damos", "shendiao-damos-eagle", "shendiao-damos-feast", "shendiao-seven-freaks", "damos-eagle"],
    enemyPool: ["shanzei", "emingke"],
    npcIds: ["guojing"],
  },
  {
  ...
  // ===== 东海 =====
  {
    ...
    events: ["shendiao-taohua", "shendiao-taohua-flute", "shendiao-taohua-maze", "taohua-array"],
